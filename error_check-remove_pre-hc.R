...
syn_flow<-readRDS(paste(typ,'/syn_hefs_flow_4885_',typ,'_ens_',z,'_12z.rds',sep=''))
...
saveRDS(syn_flow_new,paste('corr_',typ,'/syn_hefs_flow_4885_corr_',typ,'_ens_',z,'_12z.rds',sep=''))
