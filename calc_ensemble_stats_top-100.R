...
y<-sort(obs$LAMC1,decreasing=T,index.return=T)
...
saveRDS(mns_out,paste('~/syn_forecast_test/output/',outfile_hefs,'/t100_mns_out.rds',sep=''))
saveRDS(meds_out,paste('~/syn_forecast_test/output/',outfile_hefs,'/t100_meds_out.rds',sep=''))
saveRDS(vr_out,paste('~/syn_forecast_test/output/',outfile_hefs,'/t100_vr_out.rds',sep=''))

saveRDS(cumul_mns_out,paste('~/syn_forecast_test/output/',outfile_hefs,'/t100_cumul_mns_out.rds',sep=''))
saveRDS(cumul_meds_out,paste('~/syn_forecast_test/output/',outfile_hefs,'/t100_cumul_meds_out.rds',sep=''))
saveRDS(cumul_var_out,paste('~/syn_forecast_test/output/',outfile_hefs,'/t100_cumul_var_out.rds',sep=''))
